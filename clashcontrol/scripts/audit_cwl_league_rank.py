...
Usage:
    python -m clashcontrol.scripts.audit_cwl_league_rank report
    python -m clashcontrol.scripts.audit_cwl_league_rank report --clan '#2J00L8YRU'
    python -m clashcontrol.scripts.audit_cwl_league_rank fix GROUP_ID SEASON "Champion League III"
    python -m clashcontrol.scripts.audit_cwl_league_rank fix GROUP_ID SEASON "Champion League III" --yes
    python -m clashcontrol.scripts.audit_cwl_league_rank reconstruct --season 2026-07 --fresh-after 2026-07-12
    python -m clashcontrol.scripts.audit_cwl_league_rank reconstruct --season 2026-07 --fresh-after 2026-07-12 --yes
...
from clashcontrol.config import CONFIG  # noqa: E402
from clashcontrol.db_manager import explicit_column_list_from_conn  # noqa: E402
...
def report(clan_filter: Optional[str], n_seasons: int) -> None:
    ...
    print('  python -m clashcontrol.scripts.audit_cwl_league_rank fix GROUP_ID SEASON "Correct League Name" --yes')
...
async def _refresh_groups_live(
    ...
    (DISCORD_GUILD_ID) — see clashcontrol/config.py. There is no separate "which
